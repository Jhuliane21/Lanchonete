...
import org.lanchonetemaven.modelo.Carrinho;
import org.lanchonetemaven.repositorio.ProdutoRepositorio;
...
public class PedidoController {
	...
	@Autowired
	public PedidoControle(PedidoRepositorio repositorio, Pedido pedido) {
		super();
